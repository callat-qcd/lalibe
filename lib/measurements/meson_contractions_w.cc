    ...
    namespace LalibeMesonContractionsEnv
    {
        ...
        void read(XMLReader& xml, const std::string& path, MesonParams::Param_t& par)
        {
            ...
            if (paramtop.count("rotate_to_Dirac") != 0)
                ...
                {
                    QDPIO::cout<<"No XML option was specified regarding basis of propagators. Assuming DeGrand-Rossi and leaving them be [mesons]..."<<std::endl;
                    par.rotate_to_Dirac = false;
                }
