 ...
 */
#ifndef __lalibe_flavor_changing_fh_baryon_contractions_h__
#define __lalibe_flavor_changing_fh_baryon_contractions_h__
...
namespace Chroma
{
  namespace LalibeFlavorChangingFHBaryonContractionsEnv
  {
    ...
    struct FlavorChangingFHBaryonParams
    {
      FlavorChangingFHBaryonParams();
      FlavorChangingFHBaryonParams(XMLReader& xml_in, const std::string& path);
    ...
    public:
      ~InlineMeas() {}
      InlineMeas(const FlavorChangingFHBaryonParams& p) : params(p) {}
    ...
    private:
      FlavorChangingFHBaryonParams params;
    };
