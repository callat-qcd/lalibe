 ...
 *
 * Andreas Stathopoulos, Jesse Laeuchli, and Kostas Orginos. Hierarchical probing for estimating the trace of the matrix inverse on toroidal lattices, 2013, SIAM J. Sci. Comput., 35(5), S299S322, arXiv:1302.4018 [hep-lat]
 *
 */
