...
for t0 in t_src:
    ...
    params['POINT_SINK_PROP'] = 'PP_prop_'+str(t0)
    params['SMEARED_SINK_PROP'] = 'SP_prop_'+str(t0)
    f.write(xml.snk % params)
    params['OBJECT_ID'] = 'SP_prop_'+str(t0)
    params['H5_NAME'] = 'SP_prop_'+str(t0)
    f.write(xml.h5_write % params)
    params['PROP'] = 'PP_prop_'+str(t0)
    for flav in flavs:
        params['FLAV'] = flav
        for spin in spins:
            ...
            for corr in corrs:
                ...
                for ti,ts in enumerate(t_snks[corr]):
                    ...
                    params['H5_FILE']   = './test_seqsource_PP.h5'
                    params['H5_PATH']   = ''
                    ...
                    if seqprop_tsnk[ts] != 't_all':
                        ...
                        params['H5_FILE']   = './test_seqprop_PP.h5'
                        params['H5_PATH']   = ''
...
for flav in flavs:
    for spin in spins:
        for corr in corrs:
            ...
            params['OBJECT_TYPE'] = 'LatticePropagator'
            params['H5_FILE']     = './test_coherent_seqsource_PP.h5'
            params['H5_PATH']     = ''
